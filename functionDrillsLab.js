...
let comparison = compareNums(45,67)
...
let nameGreeting = nameCheck('Levi')
...
let newEmail = emailCheck('levi_r34@yahoo.com')
...
//CODE HERE
function goldFrogs(gold){
 
  return gold / 3
  }
let totalFrogs = goldFrogs(4)
...
//CODE HERE
function goldFrogs2(gold){
 
  return Math.floor(gold / 3)
  }
let totalFrogs2 = goldFrogs2(4)
